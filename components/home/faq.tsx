          ...
          {FAQS.map((faq, i) => (
            <div key={i} className="py-2">
              ...
              >
                ...
                <ChevronDown
                  className={cn('w-5 h-5 flex-shrink-0 ml-4 transition-transform duration-300', open === i && 'rotate-180 text-gold')}
                />
              </button>
              <motion.div
                initial={false}
              ...
              >
                <p className="pb-5 text-sm md:text-base text-muted-foreground leading-relaxed text-pretty">
                  {faq.a}
                </p>
              </motion.div>
            </div>
